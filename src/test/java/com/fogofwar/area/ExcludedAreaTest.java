...
public class ExcludedAreaTest {
	...
	public void containsInclusiveBoundsOnAllowedPlane() {
		AreaExclusionManager.ExcludedArea area = new AreaExclusionManager.ExcludedArea(10, 20, 30, 40, 0, 1);
	...
	public void rejectsOutsideBoundsOrPlane() {
		AreaExclusionManager.ExcludedArea area = new AreaExclusionManager.ExcludedArea(10, 20, 30, 40, 0);
